...
export const VISION_PROXY_CONFIG_KEY = 'anthropic-copilot.visionProxy.config';
export const VISION_PROXY_SOURCE_KEY = 'anthropic-copilot.visionProxy.source';
export const VISION_PROXY_API_KEY_SECRET = 'anthropic-copilot.visionProxy.apiKey';
