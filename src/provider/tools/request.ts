...
import { t } from '../../i18n';
import type { AnthropicMessage, AnthropicTool } from '../../types';
import { convertTools } from '../convert';
import { ANTHROPIC_TOOLS_LIMIT } from './consts';
...
export function collectTrailingToolResultIds(messages: readonly AnthropicMessage[]): string[] {
...
function getToolCallingLimit(toolCallingCapability: boolean | number | undefined): number {
	return typeof toolCallingCapability === 'number' ? toolCallingCapability : ANTHROPIC_TOOLS_LIMIT;
}
