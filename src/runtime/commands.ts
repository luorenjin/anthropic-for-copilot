...
export function registerCommands(context: vscode.ExtensionContext): void {
	context.subscriptions.push(
		vscode.commands.registerCommand('anthropic-copilot.showLogs', () => logger.show()),
		vscode.commands.registerCommand('anthropic-copilot.openRequestDumpsFolder', () =>
			openRequestDumpsFolder(context),
		),
		vscode.commands.registerCommand('anthropic-copilot.getApiKey', () =>
			vscode.env.openExternal(vscode.Uri.parse(EXTERNAL_URLS.anthropic.apiKeys)),
		),
		vscode.commands.registerCommand('anthropic-copilot.openSettings', () =>
			vscode.commands.executeCommand('workbench.action.openSettings', 'anthropic-copilot'),
		),
	);
}
